...
<html>
	...
	<body>
		...
		<div data-role="footer" data-theme="<?php echo $theme ?>" data-position="fixed">
            <h1 style="color: black;">Powered by <a href="http://mobilegrows.com/" rel="external">MobileGrows </a>|<a href="http://bellacapellisalonnaples.com/" rel="external"> Desktop Site</a></h1>
		</div>
		<!-- page 1 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////-->
		<div data-role="page" id="page1" data-theme="<?php echo $theme ?>">
		  ...
		  <div data-role="main" class="ui-content" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Gift Certificates</a></div>
				</div>
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Product Lines</a></div>
				</div>

				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Employment Opportunities</a></div>
				</div>	
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">CND Shellac</a></div>
				</div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Marcia Teixeira Brazilian Keratin Smoothing</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">Keratin Complex Smoothing Treatment</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
                  <div class="ui-block-a buttons-semir "><a class="ui-btn ui-icon-info ui-btn-icon-left buttons-radius" href="#home" data-transition="<?php echo $transitionefect ?>">René Furterer</a></div>
              </div>
              <div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
				...
				<div class="ui-grid-solo" data-theme="<?php echo $theme ?>">
					<section id="navigation-menu-home">
						<ul id="menu-home">
							...
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Abou US</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Specials</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Gift Certificates</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Services</a></li>
							<li><a href="#home" data-transition="<?php echo $transitionefect ?>">Product Lines</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">Employment Opportunities</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">CND Shellac</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">Marcia Teixeira Brazilian Keratin Smoothing</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">Keratin Complex Smoothing Treatment</a></li>
                            <li><a href="#home" data-transition="<?php echo $transitionefect ?>">René Furterer</a></li>
